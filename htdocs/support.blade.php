...
<nav class="navbar navbar-expand-lg navbar-light fixed-top bg-white" aria-label="Eighth navbar example">
    <div class="container">
        ...
        <!-- logo -->
        <a class="navbar-brand" href="index"><img src="img/black_logo.svg" alt="black_logo" height="30"></a>
...
<!-- header -->
<header class="masthead b-5" style="background-image: url('img/support_background.png')">
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-12 text-center">
                <h1 class="text-black">Get free support from us</h1>
            </div>
        </div>
    </div>
</header>
...
<div class="container mt">
    <h2>Get free support from us on these phone numbers</h2>
